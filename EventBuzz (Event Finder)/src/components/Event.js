...
import maps from "../images/google-maps-2020-icon.png"
import ticket from "../images/ticket.png"
import outline from "../images/start-outline.png"
...
const Event = (event) => {
  ...
  const starSource = favorite ? star : outline;
  // -- FUNCTIONS -- \\ 
      ...
      <div className="eventDiv">
        <span className="event">
              ...
              <div className="infoDiv">
                ...
                <span>
                <a className="event--icon" target="_blank"  href={(generateGoogleMapsLink(addressLine1 + ", " + addressLine2))}><img title='Directions (Google Maps)' className="event--icon--image" src={maps}></img></a>
                <a className="event--icon" title='Tickets' target="_blank" href={link}><img title='Ticket Link' className="event--icon--image" src={ticket}></img></a>
