      ...
      <div className="eventDiv">
        <span className="event">
              ...
              <div className="infoDiv">
                ...
                <a className="event--icon" title='Tickets' target="_blank" href={link}><img title='Ticket Link' className="event--icon--image" src="https://i.ibb.co/xJqPB26/ticket.png"></img></a>
